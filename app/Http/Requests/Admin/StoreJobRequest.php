...
class StoreJobRequest extends FormRequest
{
    ...
    public function withValidator($validator): void
    {
        $validator->after(function (Validator $validator): void {
            $this->validateCrossFields($validator);
        });
    }

    private function validateCrossFields(Validator $validator): void
    {
        $min = $this->input('min_years_experience');
        $max = $this->input('max_years_experience');
        ...
        $method = $this->input('application_method', JobPost::APPLICATION_INTERNAL);
        if ($method === JobPost::APPLICATION_EXTERNAL && ! $this->filled('application_url')) {
        ...
        $this->validateSkillGroups($validator);
    }

    private function validateSkillGroups(Validator $validator): void
    {
